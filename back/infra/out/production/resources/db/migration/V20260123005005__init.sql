...
ALTER TABLE streak
    ADD CONSTRAINT FK_account_TO_streak
...
ALTER TABLE resume
    ADD CONSTRAINT FK_account_TO_resume
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE block_category
    ADD CONSTRAINT FK_block_TO_block_category
        FOREIGN KEY (block_id)
            REFERENCES block (block_id);

ALTER TABLE coverletter
    ADD CONSTRAINT FK_account_TO_coverletter
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE coverletter
    ADD CONSTRAINT FK_recruitment_TO_coverletter
        FOREIGN KEY (recruitment_id)
            REFERENCES recruitment (recruitment_id);

ALTER TABLE essay
    ADD CONSTRAINT FK_coverletter_TO_essay
        FOREIGN KEY (coverletter_id)
            REFERENCES coverletter (coverletter_id);

ALTER TABLE essay
    ADD CONSTRAINT FK_question_TO_essay
        FOREIGN KEY (question_id)
            REFERENCES question (question_id);

ALTER TABLE block
    ADD CONSTRAINT FK_account_TO_block
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE community
    ADD CONSTRAINT FK_account_TO_community
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE community_tag
    ADD CONSTRAINT FK_community_TO_community_tag
        FOREIGN KEY (community_id)
            REFERENCES community (community_id);

ALTER TABLE reaction
    ADD CONSTRAINT FK_community_TO_reaction
        FOREIGN KEY (community_id)
            REFERENCES community (community_id);
...
ALTER TABLE reaction
    ADD CONSTRAINT FK_account_TO_reaction
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE comment
    ADD CONSTRAINT FK_account_TO_comment
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE follow
    ADD CONSTRAINT FK_account_TO_follow
        FOREIGN KEY (followee_id)
            REFERENCES account (account_id);

ALTER TABLE follow
    ADD CONSTRAINT FK_account_TO_follow1
        FOREIGN KEY (follower_id)
            REFERENCES account (account_id);

ALTER TABLE project
    ADD CONSTRAINT FK_account_TO_project
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);

ALTER TABLE project_tag
    ADD CONSTRAINT FK_project_TO_project_tag
        FOREIGN KEY (project_id)
            REFERENCES project (project_id);

ALTER TABLE activity
    ADD CONSTRAINT FK_account_TO_activity
        FOREIGN KEY (account_id)
            REFERENCES account (account_id);
