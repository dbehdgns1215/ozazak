                ...
                return CoverletterListResult.builder()
                                ...
                                .companyName(coverletter.getRecruitment() != null
                                                ...
                                                && coverletter.getRecruitment().getCompany().getName() != null
                                                                ? coverletter.getRecruitment().getCompany().getName()
                                                                                .value()
                                                                : null)
                                .recruitmentId(coverletter.getRecruitment() != null
                                                ? coverletter.getRecruitment().getId().value()
                                                : null)
                                .isComplete(coverletter.getIsComplete() != null ? coverletter.getIsComplete().value()
                                                : null)
                                .isPassed(coverletter.getIsPassed() != null ? coverletter.getIsPassed().value() : null)
                                .createdAt(coverletter.getCreatedAt() != null ? coverletter.getCreatedAt().value()
                                                : null)
                                .updatedAt(coverletter.getUpdatedAt() != null ? coverletter.getUpdatedAt().value()
                                                : null)
                                .build();
        }
}
